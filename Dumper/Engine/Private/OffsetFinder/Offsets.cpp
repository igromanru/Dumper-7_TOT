...
void Off::InSDK::ProcessEvent::InitPE()
{
	...
	auto IsProcessEvent = [](const uint8_t* FuncAddress, [[maybe_unused]] int32_t Index) -> bool
	{
		return (FindPatternInRange({ 0xF7, -0x1, Off::UFunction::FunctionFlags, 0x0, 0x0, 0x0, 0x0, 0x04, 0x0, 0x0 }, FuncAddress, 0x400)
			...
			// For game "The Outlast Trials" (from CL 192745) the process event function has been changed with inlined function calls inside
			|| (FindPatternInRange({ 0xF6, 0x87, -0x1, -0x1, -0x1, -0x1, -0x1, 0x0F, 0x85, -0x1, -0x1, -0x1, -0x1 }, FuncAddress, 0xF00)
			&& FindPatternInRange({ 0x41, 0xF6, 0x86, -0x1, -0x1, -0x1, -0x1, -0x1, 0x0F, 0x85, -0x1, -0x1, -0x1, -0x1 }, FuncAddress, 0xF00));
	};
